Одностраничный адаптивный лендинг строительной компании Terrace по тестовому заданию в веб-студию. Все данные вымышлены, проект доступен на Vercel. Ссылка: https://terrace-test.vercel.app/
